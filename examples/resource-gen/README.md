...
- AGENTS.md  // detail the objective, rules for working, dos and don'ts, and any step by step processes to be followed. Use this file to reference other docs and require the use of checkpoint files.
